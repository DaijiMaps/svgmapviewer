...
import type { SearchAddress, SearchInfo, SearchName } from './lib/address/types'
...
) => readonly SearchAddress[] | Promise<readonly SearchAddress[]>
...
export interface SvgMapViewerConfig
  ...
  searchInfos?: readonly SearchInfo[]
